                        ...
                        <div class="row mtop8f">
                            ...
                            <div class="col-md-6 text-right">                                
                                <div @if($nota->status<>1)style="display:none"@endif>
                                    ...
                                    <a class="btn thead-blue" href="{{ url('/admin/notfar/'.$nota->id.'/deta') }}"
                                        datatoggle="tooltip" data-placement="top" title="Agregar">
                                        <i class="fas fa-plus"></i>
                                    </a>
                                    <a class="btn thead-blue" href="{{ url('/admin/notfar/'.$nota->id.'/end') }}"
                                ...
                                @if($nota->status<>1)
                                <a class="btn thead-blue" href="{{ url('/admin/pdf/'.$nota->id.'/farmnota') }}"
                                ...
                                <a class="btn thead-blue" href="{{ url('/admin/sunat/'.$nota->id.'/notaxmlf') }}"
                    ...
                    <div class="inside">
                        <table class="table table-sm table-bordered table-sb">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $detnota->prod->nombre}}</td>
                                    <td>{{ $detnota->prod->umedida->nombre}}</td>
                                    <td class="text-center">{{ round($detnota->cantidad,2) }}</td>
                                    <td>{{ $detnota->precio}}</td>
                                    <td>{{ $detnota->subtotal }}</td>
                                    <td>
                                        <div class="opts">
                                            @if(kvfj(Auth::user()->permissions,'notfar_edit'))
                                            {{-- <a href="{{ url('/admin/ingreso/'.$detingreso->id.'/dete') }}"datatoggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-edit"></i></a> --}}
                                            <a href="{{ url('/admin/notfar/'.$detnota->id.'/detd') }}"datatoggle="tooltip" data-placement="top" title="Eliminar" onclick="return confirm('Desea eliminar el registro?')"><i class="fas fa-trash-alt"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>

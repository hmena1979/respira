...
@section('breadcrumb')
	<li class="breadcrumb-item">
		<a href="{{ url('/admin/notfars/'.$periodo) }}"><i class="fas fa-window-restore"></i> Notas de Débito/Crédito</a>
	</li>
@endsection
				...
				<div class="panel shadow">
					<div class="headercontent">
						...
						<ul>
                            <li>
                                <div class="cita">
                                    {!! Form::open(['url'=>'admin/notfar/cambio']) !!}
							...
							@if(kvfj(Auth::user()->permissions,'notfar_add'))
							<li>
								<a class="btn btn-agregar" href="{{ url('/admin/notfar/add') }}">
									Agregar registro
								</a>
                            </li>
							@endif
								...
								<tr>
									...
									<td>
										<div class="opts">
											...
											<a href="{{ url('/admin/notfar/'.$nota->id.'/edit') }}"datatoggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-edit"></i></a>
											@endif
											...
											@endif --}}
											<a href="{{ url('/admin/pdf/'.$nota->id.'/farnota') }}"

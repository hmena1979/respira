		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel shadow">
					<div class="inside">
						{!! Form::open(['url'=>'/admin/proveedor/add']) !!}
						<div class="row">
							<div class="col-md-4">
							...
							<div class="col-md-6">
								...
								{!! Form::text('razsoc', '', ['class'=>'form-control','id'=>'razsoc','autocomplete'=>'off','disabled']) !!}
							</div>
						</div>
						<div class="row mtop16">
							<div class="col-md-3">
								<label for="ape_pat">Ap Paterno:</label>
								{!! Form::text('ape_pat', '', ['class'=>'form-control','id'=>'ape_pat','autocomplete'=>'off','disabled']) !!}
							</div>
							<div class="col-md-3">
								<label for="ape_mat">Ap Materno:</label>
								{!! Form::text('ape_mat', '', ['class'=>'form-control','id'=>'ape_mat','autocomplete'=>'off','disabled']) !!}
							</div>
							<div class="col-md-3">
								<label for="nombre1">1er Nombre:</label>
								{!! Form::text('nombre1', '', ['class'=>'form-control','id'=>'nombre1','autocomplete'=>'off','disabled']) !!}
							</div>
							<div class="col-md-3">
								<label for="nombre2">2do Nombre:</label>
								{!! Form::text('nombre2', '', ['class'=>'form-control','id'=>'nombre2','autocomplete'=>'off','disabled']) !!}
							</div>
						</div>
						<div class="row mtop16">							
							<div class="col-md-5">
								<label for="direccion">Dirección:</label>
								{!! Form::text('direccion', '', ['class'=>'form-control','id'=>'direccion','autocomplete'=>'off']) !!}
							</div>
							<div class="col-md-5">
...
<script>
    $(document).ready(function(){
        ...
        document.getElementById('numdoc').addEventListener("blur",function(){
            ...
            $.get(url_global+"/admin/proveedor/"+numdoc+"/busnumdoc/",function(response){
                if (response!=""){
                    var msg = response[0].numdoc.trim() + '-' + response[0].razsoc.trim();
                    alert('Proveedor ya existe en la base de datos:\n'+msg);

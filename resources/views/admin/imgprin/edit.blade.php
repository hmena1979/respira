		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel shadow">					
					<div class="inside">
						{!! Form::open(['url'=>'/admin/web/imgprin/'.$im->id.'/edit', 'files' => true]) !!}
						<div class="row">
							<a href="{{ url('/web/'.$im->imagen) }}" data-fancybox="gallery">
								<img src="{{ url('/web/'.$im->imagen) }}" class = "img-fluid" alt="">
							</a>
						</div>
						<div class="row">
							<div class="col-md-9">
							...
							<div class="col-md-3">
								...
								{!! Form::select('activo',['1'=>'Si','2'=>'No'],$im->activo,['class'=>'custom-select']) !!}	
							</div>
						</div>

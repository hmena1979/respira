	...
	<div class="container-fluid">
                            ...
                            <div class="col-md-5">
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        {!! Form::text('fecha', $salida->fecha, ['class'=>'form-control','autocomplete'=>'off','disabled']) !!}
                                        {!! Form::select('tipsal',[1=>'VENTA',2=>'CONSUMO'],$salida->tipsal,['class'=>'custom-select','id'=>'tipsal','hidden']) !!}
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="col-md-7">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        {!! Form::text('numero', $salida->serie.'-'.$salida->numero, ['class'=>'form-control','autocomplete'=>'off','id'=>'numero','disabled']) !!}
                                    </div>
                                    <div class="col-md-8">
                                        <label class="lsinmargen" for="ruc">Cliente:</label>
                                        {!! Form::select('razsoc',$clientes,$salida->ruc,['class'=>'custom-select', 'id'=>'razsoc', 'placeholder'=>'Elija Cliente','disabled']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row mtop16">
            <div class="col-md-12">
                <div class="panel shadow">
                    <div class="inside">
                        {!! Form::open(['url'=>'/admin/salida/'.$salida->id.'/deta']) !!}
                        <div class="row">
                            <div class="col-md-5">
                        ...
                        <div class="row mtop8f">
                            ...
                            <div class="col-md-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" @if($salida->tipsal==2)style="display:none"@endif>
                            ...
                            <div class="col-md-2" @if($salida->tipsal==2)style="display:none"@endif>
    ...
    $(document).ready(function(){
        ...
        document.getElementById('producto_id').addEventListener("blur",function(){
            $.get(url_global+"/admin/producto/"+this.value+"/searchid/",function(response){
                ...
                if(document.getElementById("tipsal").value==1){
                    document.getElementById("precio").value = response[0].premerca;
                }else{
                    document.getElementById("precio").value = response[0].precompra;
                }

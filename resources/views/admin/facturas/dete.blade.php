	...
	<div class="container-fluid">
                            ...
                            <div class="col-md-5">
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        {!! Form::date('fecha', $factura->fecha, ['class'=>'form-control','autocomplete'=>'off','disabled']) !!}
                                    </div>
                                    <div class="col-md-7">
        ...
        <div class="row mtop16">
            <div class="col-md-12">
                <div class="panel shadow">
                    <div class="inside">
                        {!! Form::open(['url'=>'/admin/factura/'.$detfactura->id.'/dete']) !!}
                        <div class="row">
                            <div class="col-md-4">
                                <label class="lsinmargen" for="servicio">Servicio:</label>
                                    <div class="input-group">
                                        {!! Form::textarea('servicio',$detfactura->servicio,['class'=>'form-control', 'rows'=>'1','id'=>'servicio']) !!}
                            ...
                            <div class="col-md-1">
                                ...
                                {!! Form::text('cantidad', $detfactura->cantidad, ['class'=>'form-control','autocomplete'=>'off','id'=>'cantidad']) !!}
                            </div>
                            <div class="col-md-2">
                                <label class="lsinmargen" for="precio">Precio:</label>
                                {!! Form::text('precio', $detfactura->precio, ['class'=>'form-control','autocomplete'=>'off','id'=>'precio']) !!}
                            </div>
                            <div class="col-md-2">
                                <label class="lsinmargen" for="subtotal">Subtotal:</label>
                                {!! Form::text('subtotal', $detfactura->subtotal, ['class'=>'form-control','autocomplete'=>'off','id'=>'subtotal','disabled']) !!}
                            </div>
                            <div class="col-md-3">
                                <label class="lsinmargen" for="afectacion_id">Afectacion:</label>
                                {!! Form::select('afectacion_id',$afectacion,$detfactura->afectacion_id,['class'=>'custom-select','id'=>'afectacion_id']) !!}
                            </div>
                        </div>
                        <div class="row mtop8f">
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('precli', $detfactura->precli, ['class'=>'form-control','autocomplete'=>'off','id'=>'precli']) !!}
                                    </div>
                                    <div class="col-md-6">
                                        <label class="lsinmargen" for="stcli">Subtotal:</label>
                                        {!! Form::text('stcli', $detfactura->stcli, ['class'=>'form-control','autocomplete'=>'off','id'=>'stcli','disabled']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('predr', $detfactura->predr, ['class'=>'form-control','autocomplete'=>'off','id'=>'predr']) !!}
                                    </div>
                                    <div class="col-md-6">
                                        <label class="lsinmargen" for="stdr">Subtotal:</label>
                                        {!! Form::text('stdr', $detfactura->stdr, ['class'=>'form-control','autocomplete'=>'off','id'=>'stdr','disabled']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1">
                                {!! Form::submit('Guardar', ['class'=>'btn btn-success mtop40', 'id'=>'guardar']) !!}
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>

		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel shadow">
					<div class="inside">
						{!! Form::open(['url'=>'/admin/servicio/add']) !!}
						<div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-2">
								...
								{!! Form::text('precio', '', ['class'=>'form-control','id'=>'precio','autocomplete'=>'off']) !!}
                            </div>
                            <div class="col-md-2">
								<label for="clinica">Clínica:</label>
								{!! Form::text('clinica', '', ['class'=>'form-control','id'=>'clinica','autocomplete'=>'off']) !!}
                            </div>
                            <div class="col-md-2">
								<label for="especialista">Especialista:</label>
								{!! Form::text('especialista', '', ['class'=>'form-control','id'=>'especialista','autocomplete'=>'off']) !!}
							</div>
                        </div>

		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel shadow">
					<div class="inside">
						{!! Form::open(['url'=>'/admin/producto/add']) !!}
						<div class="row">					
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
								...
								{!! Form::select('umedida_id',$umedida,null,['class'=>'custom-select','placeholder' =>'Elija presentación']) !!}	
                            </div>
                            <div class="col-md-2">
								<label class="lsinmargen"  for="afecto">Afectación:</label>
								{!! Form::select('afecto',['1'=>'AFECTO','2'=>'EXONERADO','3'=>'INAFECTO'],1,['class'=>'custom-select']) !!}	
							</div>
                        </div>
                        <div class="row mtop10">
                            <div class="col-md-4">
								<label class="lsinmargen"  for="tipmed_id">Tipo medicamento:</label>
								{!! Form::select('tipmed_id',$tipmed,null,['class'=>'custom-select','placeholder' =>'Elija tipo de medicamento','id'=>'tipmed_id']) !!}	
                            </div><div class="col-md-4">
								<label class="lsinmargen"  for="composicion_id">Composición:</label>
								{!! Form::select('composicion_id',$composicion,null,['class'=>'custom-select','placeholder' =>'Elija composición','id'=>'composicion_id']) !!}	
                            </div><div class="col-md-4">
								<label class="lsinmargen"  for="laboratorio_id">Laboratorio:</label>
								{!! Form::select('laboratorio_id',$laboratorio,null,['class'=>'custom-select','placeholder' =>'Elija laboratorio']) !!}	
                            </div>
                        </div>
                        <div class="row mtop10">
							<div class="col-md-2">
								<label class="lsinmargen"  for="stock">Stock:</label>
								{!! Form::text('stock', '', ['class'=>'form-control','autocomplete'=>'off', 'disabled']) !!}
							</div>
							<div class="col-md-2">
								<label class="lsinmargen"  for="stockmin">Stock mínimo:</label>
								{!! Form::text('stockmin', '', ['class'=>'form-control','autocomplete'=>'off']) !!}
                            </div>
							<div class="col-md-2" style="display:@if(kvfj(Auth::user()->permissions,'producto_price')) block @else none @endif">
								...
								{!! Form::text('precompra', '', ['class'=>'form-control','autocomplete'=>'off','id'=>'precompra','disabled']) !!}
                            </div>
							<div class="col-md-2" style="display:@if(kvfj(Auth::user()->permissions,'producto_price')) block @else none @endif">
								<label class="lsinmargen"  for="porganancia">% Ganancia:</label>
								{!! Form::text('porganancia', '', ['class'=>'form-control','autocomplete'=>'off','id'=>'porganancia']) !!}
                            </div>
							<div class="col-md-2" style="display:@if(kvfj(Auth::user()->permissions,'producto_price')) block @else none @endif">
								<label class="lsinmargen"  for="premerca">Precio venta:</label>
								{!! Form::text('premerca', '', ['class'=>'form-control','autocomplete'=>'off','id'=>'premerca']) !!}
                            </div>
                            <div class="col-md-2">

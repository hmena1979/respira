		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel shadow">
					<div class="inside">
                        {!! Form::open(['url'=>'/admin/ingreso/add']) !!}
                        <div class="row">
                            <div class="col-md-3">
                                <div class="row">
                                    <div class="col-md-5">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {!! Form::date('vencimiento', null, ['class'=>'form-control','id'=>'vencimiento','autocomplete'=>'off','disabled']) !!}
                                    </div>
                                    <div class="col-md-3">
                                        <label class="lsinmargen" for="cancelacion">Cancelación:</label>
                                        {!! Form::date('cancelacion', null, ['class'=>'form-control','id'=>'cancelacion','autocomplete'=>'off','disabled']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-5">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::select('comprobante_id',$comprobante,'01',['class'=>'custom-select', 'id'=>'comprobante_id']) !!}
                                    </div>
                                    <div class="col-md-6">
                                        <label class="lsinmargen" for="num_doc">Número:</label>
                                        <div class="row no-gutters">
                                            <div class="col-md-4">
                                                {!! Form::text('serie', null, ['class'=>'form-control','autocomplete'=>'off','id'=>'serie']) !!}
                                            </div>
                                            <div class="col-md-8">								
                                                {!! Form::text('numero', null, ['class'=>'form-control','autocomplete'=>'off','id'=>'numero']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            {!! Form::select('proveedor_id',$proveedores,'',['class'=>'custom-select', 'id'=>'proveedor_id', 'placeholder'=>'Elija Proveedor']) !!}
